...
<body>
  <main class="main-container">
    ...
    <!-- Page Header -->
    <div class="header">
      <h2 class="page-title">Faculty Recruitment Management</h2>
    ...
    <div class="card-grid">
      <a href="#" class="card card-1">
        ...
        <h3 class="card-title">View Faculty Recruitments</h3>
      </a>

      <a href="#" class="card card-2">
        <div class="card-icon"><i class="fas fa-plus-circle"></i></div>
        <h3 class="card-title">Register Faculty Recruitments</h3>
      </a>

      <a href="#" class="card card-3">
        <div class="card-icon"><i class="fas fa-edit"></i></div>
        <h3 class="card-title">Update Faculty Recruitments</h3>
      </a>

      <a href="#" class="card card-4">
        <div class="card-icon"><i class="fas fa-times"></i></div>
        <h3 class="card-title">Delete Faculty Recruitments</h3>
      </a>
    </div>
  </main>
</body>
