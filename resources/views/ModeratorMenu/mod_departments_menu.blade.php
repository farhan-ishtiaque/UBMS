...
<body>
  <main class="main-container">
    ...
    <!-- Card Section -->
    <div class="card-grid">
      <a href="{{route('departments.index')}}" class="card card-1">
        <div class="card-icon"><i class="fas fa-eye"></i></div>
        <h3 class="card-title">View Departments</h3>
      </a>

      <a href="{{route('departments.create')}}" class="card card-2">
        <div class="card-icon"><i class="fas fa-plus-circle"></i></div>
        <h3 class="card-title">Register Department</h3>
      </a>

      <a href="{{route('departments.manage')}}" class="card card-3">
        <div class="card-icon"><i class="fas fa-edit"></i></div>
        <h3 class="card-title">Update Department</h3>
      </a>

      <a href="{{route('departments.deletePage')}}" class="card card-4">
