...
<body class="bg-light">
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h2 class="mb-0">Student Management - {{ $university->uni_name }}</h2>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body">
                <form method="GET" action="{{route('admin_view_students')}}">
                    <div class="form-row">
                        <!-- Department Filter -->
                    ...
                    <div class="form-row mt-2">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin_view_students') }}" class="btn btn-light px-4 ml-2">
                        ...
                        <tbody>
                            @forelse($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge {{ $student->graduation_status == 'graduated' ? 'badge-success' : 'badge-warning' }}">
                                    ...
                                    <td>
                                        @if($student->scholarship)
                                            <span class="badge {{ $student->scholarship->status == 'Recipient' ? 'badge-success' : 'badge-danger' }}">
                                                <i class="fas fa-{{ $student->scholarship->status == 'Recipient' ? 'check-circle' : 'times-circle' }} mr-1"></i>
