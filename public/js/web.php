...
Route::get('uni-admin/dashboard/admin_students_menu/student-list', [StudentMenuViewController::class, 'viewStudents'])->name('admin_view_students');
Route::get('uni-admin/dashboard/admin_students_menu/students-register', [StudentMenuAddController::class, 'create'])->name('admin_add_students');
Route::post('uni-admin/dashboard/admin_students_menu/students/register', [StudentMenuAddController::class, 'store'])->name('admin_students.store');
// AJAX for dynamic department dropdown
Route::prefix('uni-admin/dashboard/admin_students_menu/students-update')->group(function () {
    Route::get('/', [AdminStudentMenuUpdateController::class, 'index'])
        ->name('admin_update_students');

    Route::post('/update/search', [AdminStudentMenuUpdateController::class, 'search'])
        ->name('admin_students.update.search');

    Route::get('/update/{id}', [AdminStudentMenuUpdateController::class, 'getStudent'])
        ->name('admin_students.update.get');

    Route::put('/update/{id}', [AdminStudentMenuUpdateController::class, 'update'])
        ->name('admin_students.update.submit');
});
...
Route::prefix('uni-admin/dashboard/admin_students_menu')->group(function () {
    Route::get('/students-transcript', [StudentMenuTranscriptController::class, 'index'])->name('admin_students_transcript');
    Route::post('/students-transcript/search', [StudentMenuTranscriptController::class, 'search'])->name('admin.students.transcript.search');
    Route::get('/students-transcript/{id}', [StudentMenuTranscriptController::class, 'show'])->name('admin.students.transcript.show');
});
